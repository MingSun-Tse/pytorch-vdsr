...
def train(training_data_loader, optimizer, model, loss_func, epoch):
    ...
    for step, batch in enumerate(training_data_loader, 1):
        ...
        ploss_2  = 0 #get_local_structure_loss(struct_map_batch, feats_F16[2],  feats_F64[2],  loss_func2) * 5e5 * 2
        ploss_6  = 0 #get_local_structure_loss(struct_map_batch, feats_F16[6],  feats_F64[6],  loss_func2) * 1e4 * 2
        ploss_10 = get_local_structure_loss(struct_map_batch, feats_F16[10], feats_F64[10], loss_func2) * 2e4
        ploss_14 = get_local_structure_loss(struct_map_batch, feats_F16[14], feats_F64[14], loss_func2) * 2e4
        ploss_18 = get_local_structure_loss(struct_map_batch, feats_F16[18], feats_F64[18], loss_func2) * 2e4
